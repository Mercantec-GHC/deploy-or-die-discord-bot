...
export default class Guild extends Model {
    ...
    */
    constructor(
        ...
        members.forEach((member) => this.members.set(member.id, new Member(member.id, member.nick || member.user.display_name || member.user.global_name || member.user.username, this)))
    }
